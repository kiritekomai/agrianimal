...
public class EntityAIAgriOcelotSit  extends EntityAIMoveToBlock {
	   private final EntityAgriOcelot ocelot;

	   public EntityAIAgriOcelotSit(EntityAgriOcelot ocelotIn, double p_i45315_2_) {
